...
class ExpandedMainWindow:
    ...
    def _send_message(self):
        ...
        # Temporary GPT echo response
        self.root.after(500, lambda: self._add_gpt_message(
            f"I understood: '{user_text}'. Assistant integration is currently in preview mode."
        ))
    ...
    def _build_feature_buttons(self, parent):
        ...
        tk.Label(
            optim_content,
            text="A set of practical tools for optimization.",
            font=("Segoe UI", 7),
            bg="#047857",
            fg="#a7f3d0",
            padx=8
        ...
        tk.Label(
            optim_content,
            text="Settings for automatic daily execution.",
            font=("Segoe UI", 7),
            bg="#047857",
            fg="#a7f3d0",
            padx=8
        ...
        # Running tools with glowing numbers
    ...
    def _build_ai_writing_panel(self, parent):
        ...
        self.ai_messages = [
            "Your PC companion focused on keeping system resources in good shape.",
            "Optimization tools can run automatically after configuration, so daily usage stays simple.",
            "This project is built iteratively with a focus on practical system improvements.",
            "Thanks for trying PC Workman."
        ]
    ...
    def _on_closing(self):
        ...
        if ToastNotification is not None:
            ToastNotification.show(
                "PC Workman is running in the background",
                "Click the system tray icon to restore",
                duration_ms=3000
            )
