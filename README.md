...
Version: **1.0.6 (Core & UI Prototype)**  
...
It combines **live performance diagnostics**, **data logging**, and a **modular architecture** designed for integration with AI-based analytics.  
...
###  User Interface (Prototype v1.0.6)  
...
- Placeholder for `hck_GPT` — future integrated assistant for system analysis.
...
- AI module preparation for offline diagnostic reasoning.  
...
├────╮	Folder 'docs'
│    ├── `dev-structure.txt` - THIS FILE <3
│    ├── `how_it_works_cross.txt`
│    ├── `screen_v1.png` - first kaputt view.
│    ├── `screen_v2.png` - better future vision.
|    └── README_PL.md
...
| **v1.0.6** | **Current**    | Real-time core + first working UI prototype    |
| v1.0.7     | In Development | 4H mode, process patterns, `hck_GPT` assistant |
...
License MIT
Educational Open License — non-commercial, attribution required.
